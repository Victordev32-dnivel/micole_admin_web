  ...
  template: `
    <div class="edit-container">
      <div class="header-container">
        <h2 mat-dialog-title class="centered-title">Editar Grado</h2>
      </div>
      ...
      <mat-dialog-content>
        ...
        <div *ngIf="error && !loading" class="error-message">
          ...
          <span>{{ error }}</span>
          <button mat-button color="primary" (click)="cargarDatos()">
            Reintentar
          </button>
        </div>
...
export class EditGradosComponent implements OnInit {
  ...
  cargarDatos(): void {
    ...
    this.http
      .get<any>(`${this.apiBase}/grado/colegio/${this.data.idColegio}?page=1`, {
  ...
  guardar(): void {
    ...
    this.http
      .put(`${this.apiBase}/grado/${this.data.id}`, datos, {
        headers: this.getHeaders(),
      ...
      .subscribe({
        ...
        error: (err) => {
          ...
          if (err.status === 400) {
            ...
            this.error =
              'Error al actualizar el grado. Por favor, intente nuevamente.';
          }
